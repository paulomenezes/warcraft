...
namespace Warcraft.Units.Orcs
{
    class TrollAxethrower : Unit
    {
            ...
            : base(tileX, tileY, 52, 52, 1, managerMouse, managerMap, managerUnits)
        {
            ...
            information = new InformationUnit("Troll Axethrower", Race.FOREST_TROLL, Faction.HORDE, 50, 2, 360, 10, 500, 1, Util.Buildings.ORC_BARRACKS, 70 * Warcraft.FPS, 3, 4, Util.Units.TROLL_AXETHROWER, 6);
