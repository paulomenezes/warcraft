...
namespace Warcraft.Units.Humans
{
    class Footman : Unit
    {
            ...
            : base(tileX, tileY, 52, 52, 2, managerMouse, managerMap, managerUnits)
        {
            ...
            information = new InformationUnit("Footman", Race.HUMAN, Faction.ALLIANCE, 60, 6, 360, 10, 600, 1, Util.Buildings.BARRACKS, 60 * Warcraft.FPS, 6, 100, 1, 0, Util.Units.FOOTMAN);
